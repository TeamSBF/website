		...
		<div id="section2" style="display:none">
			<fieldset>
				...
				<div> <!-- div for question 2.1, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_1" <?php if (!isset($_POST['q2_1']) || $_POST['q2_1'] === "No") {echo 'style="display:none"';}?> >
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_1_1" <?php if (isset($_POST['q2_1_1']) && $_POST['q2_1_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_1_1" <?php if (isset($_POST['q2_1_1']) && $_POST['q2_1_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        ...
                        <div>
						  <label for="q2_1_2"><p class="question">2.1.b: Do you have joint problems causing pain, a recent fracture or fracture caused
											...
											column)?</p></label>
						  <div class="input"><input type="radio" name="q2_1_2" <?php if (isset($_POST['q2_1_2']) && $_POST['q2_1_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>  
						  <div class="input"><input type="radio" name="q2_1_2" <?php if (isset($_POST['q2_1_2']) && $_POST['q2_1_2'] == 'No') echo "checked";?> value="No">No</div> 
                        </div>
                        ...
                        <div>
						  ...
						  <div class="input"><input type="radio" name="q2_1_3" <?php if (isset($_POST['q2_1_3']) && $_POST['q2_1_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						  <div class="input"><input type="radio" name="q2_1_3" <?php if (isset($_POST['q2_1_3']) && $_POST['q2_1_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
				...
				<div> <!-- div for question 2.2, the sub section with id: q2.* should be indented (see parQ pdf) -->
                    <div>
					   ...
					   <div class="input"><input type="radio" onclick="s2RadiosClick(this, 'q2_2');" name="q2_2" <?php if (isset($_POST['q2_2']) && $_POST['q2_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
					   <div class="input"><input type="radio" onclick="s2RadiosClick(this, 'q2_2');" name="q2_2" <?php if (isset($_POST['q2_2']) && $_POST['q2_2'] == 'No') echo "checked";?> value="No">No</div>
                    </div>
                    
					<div class="subQuestions" id="q2_2" <?php if (!isset($_POST['q2_2']) || $_POST['q2_2'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						  ...
						  <div class="input"><input type="radio" name="q2_2_1" <?php if (isset($_POST['q2_2_1']) && $_POST['q2_2_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						  <div class="input"><input type="radio" name="q2_2_1" <?php if (isset($_POST['q2_2_1']) && $_POST['q2_2_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        ...
                        <div>
						  ...
						  <div class="input"><input type="radio" name="q2_2_2" <?php if (isset($_POST['q2_2_2']) && $_POST['q2_2_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						  <div class="input"><input type="radio" name="q2_2_2" <?php if (isset($_POST['q2_2_2']) && $_POST['q2_2_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
					</div>
				...
				<div> <!-- div for question 2.3, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_3" <?php if (!isset($_POST['q2_3']) || $_POST['q2_3'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_3_1" <?php if (isset($_POST['q2_3_1']) && $_POST['q2_3_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_3_1" <?php if (isset($_POST['q2_3_1']) && $_POST['q2_3_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_3_2" <?php if (isset($_POST['q2_3_2']) && $_POST['q2_3_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_3_2" <?php if (isset($_POST['q2_3_2']) && $_POST['q2_3_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      <label for="q2_3_3"><p class="question">2.3.c: Do you have chronic heart failure?</p></label>
						      <div class="input"><input type="radio" name="q2_3_3" <?php if (isset($_POST['q2_3_3']) && $_POST['q2_3_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_3_3" <?php if (isset($_POST['q2_3_3']) && $_POST['q2_3_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_3_4" <?php if (isset($_POST['q2_3_4']) && $_POST['q2_3_4'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_3_4" <?php if (isset($_POST['q2_3_4']) && $_POST['q2_3_4'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_3_5" <?php if (isset($_POST['q2_3_5']) && $_POST['q2_3_5'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_3_5" <?php if (isset($_POST['q2_3_5']) && $_POST['q2_3_5'] == 'No') echo "checked";?> value="No">No</div>
                        </div>      
					</div>
				...
				<div> <!-- div for question 2.4, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_4" <?php if (!isset($_POST['q2_4']) || $_POST['q2_4'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_4_1" <?php if (isset($_POST['q2_4_1']) && $_POST['q2_4_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_4_1" <?php if (isset($_POST['q2_4_1']) && $_POST['q2_4_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div><input class="input" type="radio" name="q2_4_2" <?php if (isset($_POST['q2_4_2']) && $_POST['q2_4_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div><input class="input" type="radio" name="q2_4_2" <?php if (isset($_POST['q2_4_2']) && $_POST['q2_4_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_4_3" <?php if (isset($_POST['q2_4_3']) && $_POST['q2_4_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_4_3" <?php if (isset($_POST['q2_4_3']) && $_POST['q2_4_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
					</div>
				...
				<div> <!-- div for question 2.5, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_5" <?php if (!isset($_POST['q2_5']) || $_POST['q2_5'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      <label for="q2_5_1"><p class="question">2.5.a: Do you have difficulty controlling your condition with medications or other
											...
											medications or other treatments)</p></label>
						      <div class="input"><input type="radio" name="q2_5_1" <?php if (isset($_POST['q2_5_1']) && $_POST['q2_5_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_5_1" <?php if (isset($_POST['q2_5_1']) && $_POST['q2_5_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      <label for="q2_5_2"><p class="question">2.5.b: Do you also have back problems affecting nerves or muscles?</p></label>
						      <div class="input"><input type="radio" name="q2_5_2" <?php if (isset($_POST['q2_5_2']) && $_POST['q2_5_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_5_2" <?php if (isset($_POST['q2_5_2']) && $_POST['q2_5_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
					</div>
				...
				<div> <!-- div for question 2.6, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_6" <?php if (!isset($_POST['q2_6']) || $_POST['q2_6'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      <label for="q2_6_1"><p class="question">2.6.a: Do you have difficulty controlling your condition with medications or other
											physician-prescribed therapies? (Answer NO if you are not currently taking medications or other treatments)</p></label>
						      <div class="input"><input type="radio" name="q2_6_1" <?php if (isset($_POST['q2_6_1']) && $_POST['q2_6_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_6_1" <?php if (isset($_POST['q2_6_1']) && $_POST['q2_6_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_6_2" <?php if (isset($_POST['q2_6_2']) && $_POST['q2_6_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_6_2" <?php if (isset($_POST['q2_6_2']) && $_POST['q2_6_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_6_3" <?php if (isset($_POST['q2_6_3']) && $_POST['q2_6_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_6_3" <?php if (isset($_POST['q2_6_3']) && $_POST['q2_6_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_6_4" <?php if (isset($_POST['q2_6_4']) && $_POST['q2_6_4'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_6_4" <?php if (isset($_POST['q2_6_4']) && $_POST['q2_6_4'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
					</div>
				...
				<div> <!-- div for question 2.7, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_7" <?php if (!isset($_POST['q2_7']) || $_POST['q2_7'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      <label for="q2_7_1"><p class="question">2.7.a: Do you have difficulty controlling your condition with medications or other
											physician-prescribed therapies? (Answer NO if you are not currently taking medications or other treatments)</p></label>
						      <div class="input"><input type="radio" name="q2_7_1" <?php if (isset($_POST['q2_7_1']) && $_POST['q2_7_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_7_1" <?php if (isset($_POST['q2_7_1']) && $_POST['q2_7_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>       
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_7_2" <?php if (isset($_POST['q2_7_2']) && $_POST['q2_7_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_7_2" <?php if (isset($_POST['q2_7_2']) && $_POST['q2_7_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>     
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_7_3" <?php if (isset($_POST['q2_7_3']) && $_POST['q2_7_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_7_3" <?php if (isset($_POST['q2_7_3']) && $_POST['q2_7_3'] == 'No') echo "checked";?> value="No">No</div>
                       </div>      
					</div>
				...
				<div> <!-- div for question 2.8, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_8" <?php if (!isset($_POST['q2_8']) || $_POST['q2_8'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      <label for="q2_8_1"><p class="question">2.8.a: Do you have difficulty controlling your condition with medications or other
											physician-prescribed therapies? (Answer NO if you are not currently taking medications or other treatments)</p></label>
						      <div class="input"><input type="radio" name="q2_8_1" <?php if (isset($_POST['q2_8_1']) && $_POST['q2_8_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_8_1" <?php if (isset($_POST['q2_8_1']) && $_POST['q2_8_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      <label for="q2_8_2"><p class="question">2.8.b: Do you have any impairment in walking or mobility?</p></label>
						      <div class="input"><input type="radio" name="q2_8_2" <?php if (isset($_POST['q2_8_2']) && $_POST['q2_8_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_8_2" <?php if (isset($_POST['q2_8_2']) && $_POST['q2_8_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_8_3" <?php if (isset($_POST['q2_8_3']) && $_POST['q2_8_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_8_3" <?php if (isset($_POST['q2_8_3']) && $_POST['q2_8_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>    
					</div>
				...
				<div> <!-- div for question 2.9, the sub section with id: q2.* should be indented (see parQ pdf) -->
					...
					<div class="subQuestions" id="q2_9" <?php if (!isset($_POST['q2_9']) || $_POST['q2_9'] === "No") {echo 'style="display:none"';}?>>
                        <div>
						      ...
						      <div class="input"><input type="radio" name="q2_9_1" <?php if (isset($_POST['q2_9_1']) && $_POST['q2_9_1'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_9_1" <?php if (isset($_POST['q2_9_1']) && $_POST['q2_9_1'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                       <div> 
						      ...
						      <div class="input"><input type="radio" name="q2_9_2" <?php if (isset($_POST['q2_9_2']) && $_POST['q2_9_2'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_9_2" <?php if (isset($_POST['q2_9_2']) && $_POST['q2_9_2'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
                        <div>
						      <label for="q2_9_3"><p class="question">2.9.c: Do you currently live with two chronic conditions?</p></label>
						      <div class="input"><input type="radio" name="q2_9_3" <?php if (isset($_POST['q2_9_3']) && $_POST['q2_9_3'] == 'Yes') echo "checked";?> value="Yes">Yes</div>
						      <div class="input"><input type="radio" name="q2_9_3" <?php if (isset($_POST['q2_9_3']) && $_POST['q2_9_3'] == 'No') echo "checked";?> value="No">No</div>
                        </div>
					</div>
