 ...
 * Time: 4:24 PM
 */
require '../DbModel/DbManager.php';
require '../Controller/SbfController.php';


echo "Performing basic database testing on sbf_database...<br>\n";
echo "Instanciating a DB object...<br>\n";

$user1 = ['email' => 'user1@hotmail.com', 'lastName' => 'awwad', 'firstName' => 'sami', 'username' => 'chiiro', 'gender' => '1', 'dob' => '12/14/1982'];
$user2 = ['email' => 'user2@hotmail.com', 'lastName' => 'watt', 'firstName' => 'dan', 'username' => 'asshole', 'gender' => '0', 'dob' => '12/12/1985'];
