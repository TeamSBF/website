    ...
    <form method="post" class="form-horizontal">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <label class="control-label col-sm-4">Control Group (will NOT participate in Sit and Be Fit)</label>
          ...
          <div class="form-group">
            <label class="control-label col-sm-4">Experimental Group (participate in Sit and Be Fit)</label>
            <label class="radio-inline"><input type="radio" name="experimentalGrp" required checked value=1>Yes</label>
            <label class="radio-inline"><input type="radio" name="experimentalGrp" value=0>No</label>
          </div>
