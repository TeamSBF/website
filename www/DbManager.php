...
class DbManager
{
    ...
    public function addUser($usr)
    {
        try {
            $this->connection = $this->connect();
            $stmt = $this->connection->prepare("INSERT INTO user (Email, LastName, FirstName, UserName, Gender, DOB, Password)"
                . " VALUES (:email, :lastName, :firstName, :userName, :gender, :dob, :password)");
    ...
    public function authenticateMember($login)
    {
